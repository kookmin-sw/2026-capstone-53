...
> **버전**: v1.1.33-MVP
> **최종 수정**: 2026-05-16 (이상진 — §11.1 `Place` lat/lng WGS84 범위 (±90/±180) 가드 + ODsay/TMAP client 좌표 DEBUG 로그 PII 마스킹. ODsay/TMAP 외부 호출 단계 5xx 누출 + 운영 DEBUG 시 사용자 정확 위치 누출 두 결함 동시 차단.)
